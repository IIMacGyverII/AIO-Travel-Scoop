...
const DataTableAxios = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then(function (response) {
        console.log("tableData Hotel response.data", response.data);
        console.log("tableData Hotel  Hotel", [response.data.airline[0].name]);
        console.log("tableData Hotel airline array", [response.data.airline])
        ...
        console.log("tableData Hotel airline1  Hotel", airline1);
        //
        // console.log("tableData Hotel attempted array", [response.data]);
  ...
  console.log("tableData Hotel", tableData);
  console.log("andrew Hotel", airlineData)
