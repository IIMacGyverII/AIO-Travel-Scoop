...
const HotelCards = () => {
  ...
  const classes = useStyles();
  const [setLoading, setLoadingData] = useState(false);
...
axios.request(options).then(function (response) {
  ...
  return hotelData.map((hotel) => (
    ...
    >
      <CardActionArea href="https://www.wyndhamhotels.com/ramada/golden-valley-minnesota/ramada-golden-valley-minneapolis/overview">
        <CardContent>
          <div>
